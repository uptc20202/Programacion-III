#include <iostream> //Libreria Input/Output Stream Como Scanner 
/*
...
using namespace::std; //diferenciar mismos nombres en diferentes librerias

struct nodo{ //Similar a Crear Objetos En Java
	int dato;
	nodo* siguiente;
	nodo* atras;
} *primero, *ultimo;
...
int main(){
	...
	do
	{
		...
		case 2:
			...
			cout <<  buscarNodo()->dato << " Encontrado";
			break;
		case 3:
...
void insertarNodo(){
	...
	cin >> nuevo->dato;//Acedemos a una variable en especifico del nodo
